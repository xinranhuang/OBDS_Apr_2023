...
## specified as HOURS:MINUTES:SECONDS. This example is one hour.
#SBATCH --time=1:00:00
...
samtools sort -o ERR1755087.bam -@ 4 ERR1755087.sam
samtools index ERR1755087.bam

samtools idxstats ERR1755087.bam > ERR1755087.idxstats
samtools flagstat ERR1755087.bam > ERR1755087.flagstat
